...
public class ObjectManager {
	...
	private BufferedImage spikeImg,cannonBallImgs;
	...
	private void drawProjectiles(Graphics g, int xLvlOffset) {
		for(Projectile p:projectiles){
			if(p.isActive())
				g.drawImage(cannonBallImgs,(int)(p.getHitbox().x-xLvlOffset),(int)(p.getHitbox().y),CANNON_BALL_WIDTH,CANNON_BALL_HEIGHT,null);
		}
	}
